...
interface GroupByRequest extends Request {
  prisma: PrismaClient;
  query: Partial<Prisma.TransferGroupByArgs> & ParsedQs;
...
export async function TransferGroupBy(req: GroupByRequest, res: Response, next: NextFunction) {
  try {
    ...
    // @ts-ignore
    const result = await req.prisma.transfer.groupBy(req.query);
