...
interface GroupByRequest extends Request {
  prisma: PrismaClient;
  query: Partial<Prisma.FiatCurrencyGroupByArgs> & ParsedQs;
...
export async function FiatCurrencyGroupBy(req: GroupByRequest, res: Response, next: NextFunction) {
  try {
    ...
    // @ts-ignore
    const result = await req.prisma.fiatCurrency.groupBy(req.query);
