...
export interface FindManyRequest extends Request {
  prisma: PrismaClient;
  query: Prisma.ExternalTransferFindManyArgs & ParsedQs;
...
export type FindManyMiddleware = RequestHandler<ParamsDictionary, any, any, Prisma.ExternalTransferFindManyArgs & ParsedQs, Record<string, any>>

export async function ExternalTransferFindMany(req: FindManyRequest, res: Response, next: NextFunction) {
  try {
