...
interface GroupByRequest extends Request {
  prisma: PrismaClient;
  query: Partial<Prisma.FiatWalletGroupByArgs> & ParsedQs;
...
export async function FiatWalletGroupBy(req: GroupByRequest, res: Response, next: NextFunction) {
  try {
    ...
    // @ts-ignore
    const result = await req.prisma.fiatWallet.groupBy(req.query);
