...
interface GroupByRequest extends Request {
  prisma: PrismaClient;
  query: Partial<Prisma.CryptoWalletGroupByArgs> & ParsedQs;
...
export async function CryptoWalletGroupBy(req: GroupByRequest, res: Response, next: NextFunction) {
  try {
    ...
    // @ts-ignore
    const result = await req.prisma.cryptoWallet.groupBy(req.query);
